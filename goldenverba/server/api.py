...
async def query(payload: QueryPayload):
    ...
    if payload.nationality == "Iranian":
        if payload.alignment == "Right-wing":
            payload.query = "I am " + payload.nationality + " and I am " + payload.alignment + "I prioritize religious ties with Afghanistan and avoid water conflicts due to shared Islamic beliefs"
        elif payload.alignment == "Left-wing":
            payload.query = "I am " + payload.nationality + " and I am " + payload.alignment + "I prioritize border security and economic gains with Afghanistan over water concerns"
    elif payload.nationality == "Afghan":
        if payload.alignment == "Right-wing":
            payload.query = "I am " + payload.nationality + " and I am " + payload.alignment + """1. I acknowledge the Hirmand Treaty with Iran to avoid water tensions, indicating a willingness to engage on specific issues.
2. My conservative Islamic ideology influences my water management, but my loyalty to Iran is questionable as they prioritize my own water needs."""
        elif payload.alignment == "Left-wing":
            payload.query = "I am " + payload.nationality + " and I am " + payload.alignment + """1. Water is a top priority for me, and I am willing to escalate the Helmand Water conflict to secure my water rights.
2. I prioritize Afghanistan's interests over environmental concerns, as seen in my advocacy for diverting the Helmand River.
3. I use water to create a national identity and otherize Iran, seeking support from the West."""
